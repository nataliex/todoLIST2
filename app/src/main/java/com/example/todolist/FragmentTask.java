...
public class FragmentTask extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Log.d("Main task path",toDoViewModel.getCurrentTask().getPath().toString());
        Log.d("Main task name",toDoViewModel.getCurrentTask().getName().toString());
        Log.d("Main task description",toDoViewModel.getCurrentTask().getDescription().toString());
        Log.d("Main task done",toDoViewModel.getCurrentTask().getIsDone().toString());
        Log.d("Main task parentId",toDoViewModel.getCurrentTask().getParentId().toString());
        Log.d("Main task id",toDoViewModel.getCurrentTask().getId().toString());
        Log.d("Main task Star",toDoViewModel.getCurrentTask().getStarMark().toString());
        ...
        public AdapterTask(final TextView mTvNoneTasks) {
            ...
            toDoViewModel.getObservableCurrentTasks().observe(FragmentTask.this,new Observer<List<Task>>() {
                ...
                public void onChanged(@Nullable List<Task> tasks) {
                    Log.d("FragmentTaskObserver:","isCalled");
                    Log.d("QuantityOfElements:",Integer.toString(tasks.size()));
                    mArrayTasks.clear();
